...
nnoremap <silent> <leader>fb<cr> :Buffers<cr>
nnoremap <silent> <leader>f<cr> :Files<cr>
nnoremap <silent> <Leader>ff<cr> :Files <c-r>=expand('%:h')<cr><cr>
nnoremap <silent> <Leader>fff<cr> :call Skim_files()<cr>
...
xmap <leader>fmat  <Plug>(coc-format-selected)
nmap <leader>fmat  <Plug>(coc-format-selected)
...
nnoremap <silent> <space>xa  :<C-u>CocList diagnostics<cr>
" Manage extensions
